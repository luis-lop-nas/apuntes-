...
\begin{enumerate}
  \item \textbf{Resumir} el conjunto original en pocas variables derivadas,
        minimizando la pérdida de información relevante.
  ...
  \item \textbf{Relacionar} dos bloques de variables para estudiar estructura
...
variables} y distingue entre modelos de dependencia, interdependencia y
...
multivariante completo de una unidad.
...
el documento porque permite expresar con claridad medias, centrado, covarianzas
y proyecciones lineales.
\end{definicion}
...
En esta materia aparecen de forma recurrente varios tipos de matrices:
\begin{itemize}
...
conjunta añade, además, la estructura de dependencia entre componentes.
...
\]
Como $D_A^2<D_B^2$, se clasifica en el grupo $A$. El ejemplo ilustra que la
regla no se basa en distancia euclídea, sino en distancia reescalada por la
estructura de covarianza común.
